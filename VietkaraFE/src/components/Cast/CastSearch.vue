...
export default {
    ...
    return {
      ...
      categories: [
        ...
        },
        {
          name: 'キャストタイプ2',
          items: [
            { model: 'castType', id: 'cat8', name: 'cat8', value: '飲み系', label: '癒し系' },
            { model: 'castType', id: 'cat9', name: 'cat9', value: '面白い系', label: 'クール系' },
            { model: 'castType', id: 'cat10', name: 'cat10', value: 'かわいい系', label: 'お姫さま系' },
            { model: 'castType', id: 'cat11', name: 'cat11', value: 'セクシー系', label: 'セクシー系' },
            { model: 'castType', id: 'cat12', name: 'cat12', value: 'きれい系', label: '歌姫' },
          ],
        },
        {
          name: 'オプション',
          items: [
            { model: 'castType', id: 'cat13', name: 'cat13', value: '連絡大歓迎', label: '連絡大歓迎' },
            { model: 'castType', id: 'cat14', name: 'cat14', value: 'foreign', label: '外国人' },
            { model: 'castType', id: 'cat15', name: 'cat15', value: 'position', label: '役職あり' },
            { model: 'castType', id: 'cat16', name: 'cat16', value: 'isNew', label: '新規掲載' },
          ]
        },
        {
          name: '年代',
          items: [
            { model: 'age_ranges', id: 'cat17', name: 'cat17', value: '10s', label: '10代' },
            { model: 'age_ranges', id: 'cat18', name: 'cat18', value: '20s', label: '20代' },
            { model: 'age_ranges', id: 'cat19', name: 'cat19', value: '30s', label: '30代' },
            { model: 'age_ranges', id: 'cat20', name: 'cat20', value: '40s', label: '40代' },
            { model: 'age_ranges', id: 'cat21', name: 'cat21', value: 'beginner', label: '初心者' },
          ],
        },
      ],
  ...
  methods: {
    ...
    goToCastDetail(castId) {
        this.$router.push({ name: 'CastPage', params: { castId } });
    },
...
.cards{
    ...
    .v-row{
      display: flex;
      justify-content: space-around;  /* これでカード間の間隔が均等になります */
      flex-wrap: wrap;
    }
}
.card{
    text-align: center;
    box-sizing: border-box;  /* ボーダーのサイズを含めた全体のサイズを確保します */
    width: calc(33.3333% - 4px);  /* グリッドの1/3の幅を持つカード。マージンやパディングの分を引きます */
  .avt{
      border: 1px black solid;
      background-color: #D9D9D9;
      height: 175px; /* 固定の高さ */
      width: calc(175px * (2/3));
      position: relative;  /* 画像を絶対位置で配置するため */
