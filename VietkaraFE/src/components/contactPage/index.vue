            ...
            <div class="feedback">
                ...
                <div class="form">
                    <div class="Form-Item">
                        ...
                        <v-text-field v-model="storeName" class="Form-Item-Input" placeholder="例）株式会社令和"></v-text-field>
                    </div>
                    <div class="Form-Item">
                        <p class="Form-Item-Label"><span class="Form-Item-Label-Required">必須</span>電話番号</p>
                        <!-- v-text-field を使用 -->
                        <v-text-field v-model="phoneNumber" class="Form-Item-Input" placeholder="例）0123456789" type="number"></v-text-field>
                    </div>
                    <div class="Form-Item">
                        <p class="Form-Item-Label"><span class="Form-Item-Label-Required">必須</span>メールアドレス</p>
                        <!-- v-text-field を使用 -->
                        <v-text-field v-model="email" class="Form-Item-Input" placeholder="例）example@gmail.com" type="email"></v-text-field>
                    </div>
                    <div class="Form-Item">
                        <p class="Form-Item-Label isMsg"><span class="Form-Item-Label-Required">必須</span>お問い合わせ内容</p>
                        <!-- v-textarea を使用 -->
                        <v-textarea v-model="message" class="Form-Item-Textarea" placeholder=""></v-textarea>
                    </div>
